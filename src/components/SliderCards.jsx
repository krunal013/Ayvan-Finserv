...
const SliderCard = () => {
  useEffect(() => {
    // Initialize Swiper instance with breakpoints for responsiveness
    ...
    // Set up custom sliding logic: slide forward until last slide, then reverse
    let direction = 1; // 1 means forward, -1 means backward
    const intervalId = setInterval(() => {
      // Check current index and total slides
      ...
      if (currentIndex === totalSlides - 1) {
        ...
        // If at the first slide, forward direction again
        direction = 1;
      }

      // Slide in the current direction
      if (direction === 1) {
  ...
  // Map testimonial id to corresponding icon
  const iconMap = {
  ...
  const testimonials = [
    {
      ...
      role: "CEO",
      review:
        "Medical emergencies are unpredictable and very expensive; henceforth having a health insurance is not a luxury but a necessity.",
    },
    {
      id: 2,
      ...
      review:
        "It is mandatory to have vehicle insurance to drive legally. A good policy covers any perceivable damage or loss.",
    },
    {
      id: 3,
      ...
      role: "Developer",
      review:
        "Protect the structure and contents of your house. Risks include fire, theft and weather changes.",
    },
    {
      id: 4,
      ...
      role: "Developer",
      review:
        "Travel insurance covers risks such as loss of passport, checked baggage and flight disruptions.",
    },
    {
      id: 5,
      ...
      role: "Developer",
      review:
        "Protects businesses from financial losses due to unforeseen risks.",
    },
    {
      id: 6,
      ...
      role: "Developer",
      review:
        "Covers damage or destruction of shipments during import and export.",
    },
    {
      id: 7,
      ...
      role: "Developer",
      review:
        "Protects against claims for injuries or damage to people or property.",
    },
  ];
  ...
  return (
    <section className="py-24 relative">
            ...
            <div className="swiper-wrapper">
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="swiper-slide">
                  <div
                    // Fixed height for all cards with responsive width
                    className="group  bg-white border-2 border-dotted border-gray-500 rounded-xl p-6 h-72 overflow-hidden transition-all duration-500 w-full md:w-11/12 lg:w-3/4 mx-auto hover:border-orange-600 hover:shadow-sm"
                  >
      ...
      {/* Custom CSS to apply orange border for the active slide */}
      <style jsx>{`
