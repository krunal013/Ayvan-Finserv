...
import chintanbhai from "../public/images/chintan.jpg";

const slides = [
  {
    title: "Plan your finances and",
    highlight: "Maximize your wealth",
    description:
      "Tailored financial strategies to help you grow, manage, and protect your investments.",
    buttonText: "GET STARTED",
    image: chintanbhai, // Corrected path
  },
  {
    title: "Secure your future with",
    highlight: "Smart Investments",
    description:
      "Expert insights and proven strategies to build a strong financial portfolio.",
  ...
  },
  {
    ...
    description:
      "Personalized investment solutions designed to help you reach your financial goals faster.",
      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            <div
              className="relative w-full h-[150px] sm:h-[150px] md:h-[500px] lg:h-[620px] flex items-center text-left text-white"
              style={{
