   ...
   return (
     <div className="lg:m-5 rounded-xl bg-gray-50">
       ...
       <div className="p-16 mb-5">
         <h2 className="text-2xl font-semibold text-gray-800 mb-3">What is a SIP?</h2>
       ...
       <div className="p-5 mt-5 ml-12">
         ...
         <h2 className="text-2xl font-semibold text-gray-800 mt-5 mb-3">How to Use This SIP Calculator</h2>
         <p className="text-gray-700 leading-relaxed mb-3">
           Enter the following details to calculate the potential returns on your SIP investment:
         </p>
         <ul className="list-disc list-inside text-gray-700 leading-relaxed mb-3">
           <li><strong>Amount:</strong> The fixed amount you wish to invest regularly.</li>
           <li><strong>Duration:</strong> The investment period in years.</li>
           <li><strong>Rate of Return:</strong> The expected annual rate of return (in percentage).</li>
           <li><strong>Inflation:</strong> Choose whether to consider a hypothetical inflation rate of 6% per annum.</li>
         </ul>
         <p className="text-gray-700 leading-relaxed">
           The calculator will then show you the total amount invested and the estimated total value of your investment at the end of the chosen period. The pie chart provides a visual breakdown of your investment and the returns.
         </p>

         <h2 className="text-2xl font-semibold text-gray-800 mt-5 mb-3">Important Considerations</h2>
         <p className="text-gray-700 leading-relaxed mb-3">
           Please remember that the results from this calculator are for illustrative purposes only.
         </p>
         <ul className="list-disc list-inside text-gray-700 leading-relaxed">
           <li>Investment in mutual funds is subject to market risks. The actual returns may vary.</li>
           <li>Inflation can significantly impact the real value of your returns over time.</li>
           <li>It's crucial to choose investment schemes that align with your financial goals and risk tolerance.</li>
           <li>Consider consulting with a financial advisor for personalized investment advice.</li>
         </ul>
       </div>
     </div>
   );
